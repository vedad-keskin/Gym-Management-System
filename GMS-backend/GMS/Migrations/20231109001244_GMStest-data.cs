...
{
    public partial class GMStestdata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 99f, 3, 809f, 1, "Gold Standard 100% Casein", "Korištenjem samo vrhunskog kazeina kao izvora proteina u svom 100% Gold Standard Casein-u, Optimum Nutrition je stvorio formulu koja postavlja standard za sve sporootpuštajuće proteine.", "assets/2sup.webp" },
                    ...
                    { 9, 75f, 2, 400f, 2, "Amino Build Performance", "Napunjene sa gradivnim elementima kako bi podržale brz oporavak. Imajući u vidu da su BCAA kao osnova u sastavu, ubrzat će period oporavka poslije treninga.", "assets/9sup.webp" },
                    ...
                    { 22, 99f, 3, 2700f, 4, "Serious Mass", "Vrh u formulama za povećanje tjelesne mase. Serious Mass vas opskrbljuje sa alatom neophodnim da napakujete kilograme i razvijete tijelo kakvo ste uvijek željeli.", "assets/22sup.webp" },
